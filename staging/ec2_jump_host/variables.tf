...
variable "path_keypair_public" {
  description = "Path ke terraform.tfstate"
  type        = string
  default     = "../security_group_public/keypair_public_staging.pem"
}

variable "path_keypair_private" {
  description = "Path ke terraform.tfstate"
  type        = string
  default     = "../security_group_private/keypair_private_staging.pem"
}

variable "name_keypair_private" {
  description = "Path ke terraform.tfstate"
  type        = string
  default     = "keypair_private_staging.pem"
}
variable "name_keypair_public" {
  description = "Path ke terraform.tfstate"
  type        = string
  default     = "keypair_public_staging.pem"
}